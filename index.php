    ...
    <div class="content">
        ...
        ?>
            <div class="deal-of-day">
                ...
                <img src="uploads/<?php echo htmlspecialchars($deal_of_day['main_image']); ?>" alt="<?php echo htmlspecialchars($deal_of_day['product_name']); ?>" class="product-image">
        ...
        <div class="products-list">
            <?php while ($product = $result_all_deals->fetch_assoc()) { ?>
                <div class="product-item">
                    <img src="uploads/<?php echo htmlspecialchars($product['main_image']); ?>" alt="<?php echo htmlspecialchars($product['product_name']); ?>" class="product-image">
